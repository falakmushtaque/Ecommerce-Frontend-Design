document.addEventListener('DOMContentLoaded', function() {
    ...
    function initGridView() {
        ...
        productCards.forEach(card => {
            ...
            card.addEventListener('click', function(e) {
                ...
                // Get product details
                const productName = this.querySelector('.grid-product-card__title').textContent;
                const productPrice = this.querySelector('.current-price').textContent;
                const productImage = this.querySelector('.grid-product-card__image').src;
        ...
        // Add styles for quick actions and hover effects
        ...
        document.addEventListener('click', function(e) {
            ...
            if (e.target.closest('.add-to-cart-btn')) {
                ...
                const productName = card.querySelector('.grid-product-card__title').textContent;
                const productPrice = card.querySelector('.current-price').textContent;
                const productImage = card.querySelector('.grid-product-card__image').src;
                const productId = productName.toLowerCase().replace(/[^a-z0-9]/g, '-');
            ...
            if (e.target.closest('.quick-view-btn')) {
                ...
                const productPrice = card.querySelector('.current-price').textContent;
                const productImage = card.querySelector('.grid-product-card__image').src;
                const rating = card.querySelector('.rating-count')?.textContent || '0';
                const productId = productName.toLowerCase().replace(/[^a-z0-9]/g, '-');
                
                // Show quick view modal
                showQuickViewModal(productId, productName, productPrice, productImage, rating);
            }
            ...
            if (e.target.closest('.favorite-btn')) {
                ...
                const card = favoriteBtn.closest('.grid-product-card');
                const productName = card.querySelector('.grid-product-card__title').textContent;
                const productId = productName.toLowerCase().replace(/[^a-z0-9]/g, '-');
                ...
                if (favoriteBtn.classList.contains('active')) {
                    ...
                    addToWishlist({
                        ...
                        image: card.querySelector('.grid-product-card__image').src
                    });
                } else {
     ...
     * Show quick view modal
     */
    function showQuickViewModal(productId, productName, productPrice, productImage, rating) {
        // Create modal
                ...
                <div class="quick-view-grid">
                    ...
                    <div class="quick-view-details">
                        ...
                        <p class="quick-view-description">
                            This premium product features high-quality materials and expert craftsmanship. Perfect for everyday use with its durable design and elegant look.
                        </p>
